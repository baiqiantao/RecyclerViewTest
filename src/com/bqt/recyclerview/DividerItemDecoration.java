 ...
 * 适合用在LinearLayoutManager上，不适合GridLayoutManager
 * 因为一行有多个childItem时会多次绘制，并且Item如果为最后一列则右边无间隔线，如果为最后一行则底部无分割线
 */
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
	...
	public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
		if (mOrientation == VERTICAL_LIST) outRect.set(0, 0, 0, mDivider.getIntrinsicHeight());
